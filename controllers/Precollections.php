	...
	*/
	...
	public function action()
	{
		...
		if($validation->withRequest($this->request)->run()) 
		{
			...
			Email: jmfallang@centronservices.com<br><br><br>
			----------------------------------------------------------------------";
	...
	public function save()
	{
		...
		$EmailStr .= "---------------------------------------<br><br>
		A Precollection Record has just been added to the database.  You should go to your Maintenance Console to download this record.   <br><br><br><br> 
		-------------------<br><br>
		CLIENT INFO:<br>
		-------------------<br><br>
		...
		$email->setMailType('html');
		$email->setFrom($SystemEmailUser, '');
		$email->setSubject('Centron Precollection Record');
			...
			foreach($id_arr as $id)	
			{
				...
				{		  
					...
					if($i==0)
					{
						...
						$email->setMailType('html');
						$email->setFrom($SystemEmailUser, '');
						$email->setSubject('Centron Managed Account Record');
